      ...
      <div className="bg-[#1e1e1e] border border-[#2b2b2b] rounded-2xl w-full max-w-md overflow-hidden shadow-2xl">
        ...
        <div className="px-6 py-4 border-b border-[#2b2b2b] flex items-center justify-between bg-[#181818]">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-sm font-semibold text-slate-100">Create Server Group</h3>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-[#181818] border border-zinc-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-100 placeholder-slate-500 focus:outline-none focus:border-sky-500 transition-all"
              autoFocus
            />
          </div>
